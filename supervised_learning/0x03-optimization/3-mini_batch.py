...
def train_mini_batch(X_train, Y_train, X_valid, Y_valid, batch_size=32,
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(epochs+1):
            ...
            train_cost = sess.run(loss, feed_dict={x: X_shuffled,
                                                   y: Y_shuffled})
            train_accuracy = sess.run(accuracy, feed_dict={x: X_shuffled,
                                                           y: Y_shuffled})
